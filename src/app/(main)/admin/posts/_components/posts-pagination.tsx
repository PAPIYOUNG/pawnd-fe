...
interface PostsPaginationProps {
  ...
  shownCount: number;
  // ค่าตัวกรองปัจจุบัน (search/type/status) ที่ต้องแนบไปกับลิงก์เปลี่ยนหน้าทุกครั้ง
...
/**
 * PostsPagination (Server Component)
 * - แถบแบ่งหน้าสำหรับตารางประกาศ ใช้ Link ไปที่ `?page=` พร้อมคงค่าตัวกรองเดิมไว้เสมอ
 */
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-3 border-t border-border pt-4 text-sm sm:flex-row">
      <span className="text-xs text-muted-foreground">
        กำลังแสดงประกาศ {shownCount.toLocaleString('th-TH')} รายการ จากทั้งหมด{' '}
