  ...
  return (
    <section className="w-full py-12 sm:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Map Container */}
        <div className="relative mt-8 overflow-hidden rounded-3xl border border-border/80 bg-[#FDF9F3] shadow-md">
          ...
          <div className="relative h-[320px] w-full sm:h-[400px]">
            ...
            >
              {/* Map Land Background */}
              <rect width="1000" height="500" fill="#FBF5EB" />
              ...
              {/* Bridges over river */}
              <rect x="195" y="240" width="24" height="48" fill="#FFFFFF" rx="2" />
              <rect x="575" y="248" width="24" height="48" fill="#FFFFFF" rx="2" />

              {/* Map Location Pins */}
              {/* Lost Pet Pin 1 (Red) */}
              <g transform="translate(480, 220)">
                <circle cx="0" cy="0" r="16" fill="#EF4444" opacity="0.2" className="animate-ping" />
            ...
            <div className="absolute top-4 left-4 z-10 max-w-[260px] rounded-2xl border border-border/80 bg-white/95 p-4 shadow-md backdrop-blur-xs sm:top-6 sm:left-6 sm:max-w-xs">
